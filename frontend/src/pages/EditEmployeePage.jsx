      ...
      <nav className="bg-white border-b border-gray-200 px-8 py-4 sticky top-0 z-20 shadow-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => navigate('/employee-list')} className="p-2 hover:bg-gray-100 rounded-full transition-colors text-gray-600">
              <ArrowLeft size={24} />
            </button>
            <h1 className="text-xl font-bold text-gray-900">แก้ไขประวัติพนักงาน</h1>
          </div>
